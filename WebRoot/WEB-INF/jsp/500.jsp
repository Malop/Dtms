...
<style>
#wrapper_wrapper {color: #333; background: #fff; padding: 0; margin: 0; position: relative; font-family: arial; font-size: 12px }
...
#wrapper_wrapper #content_left {padding-left: 12px; padding-top: 5px }
