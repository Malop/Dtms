...
<div id="createDialog">
	<form id="createForm" method="post" class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="certId" type="text" class="form-control" name="certid" maxlength="18" required>
			</div>
		</div>
		<div class="form-group">
			<label for="partyName" class="col-md-3 control-label">党员名称</label>
			<div class="col-md-9">
				<input id="partyName" type="text" class="form-control" name="partyname" maxlength="10" required>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<input id="nation" type="text" class="form-control" name="nation" maxlength="20" required>
			</div>
		</div>
		<div class="form-group">
			<label for="nativeplace" class="col-md-3 control-label">籍贯</label>
			<div class="col-md-9">
				<input id="nativeplace" type="text" class="form-control" name="nativeplace" maxlength="20" required>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="brithday" type="text" class="form-control" name="brithday" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="age" class="col-md-3 control-label">年龄</label>
			<div class="col-md-9">
				<input id="age" type="text" class="form-control" name="age" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="education" class="col-md-3 control-label">学历</label>
			<div class="col-md-9">
				<input id="education" type="text" class="form-control" name="education" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="category" class="col-md-3 control-label">人员类别</label>
			<div class="col-md-9">
				<input id="category" type="text" class="form-control" name="category" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="partygroup" class="col-md-3 control-label">党组织</label>
			<div class="col-md-9">
				<input id="partygroup" type="text" class="form-control" name="partygroup" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="partytime" class="col-md-3 control-label">入党时间</label>
			<div class="col-md-9">
				<input id="partytime" type="text" class="form-control" name="partytime" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="fullpartytime" class="col-md-3 control-label">转正时间</label>
			<div class="col-md-9">
				<input id="fullpartytime" type="text" class="form-control" name="fullpartytime" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="job" class="col-md-3 control-label">工作岗位</label>
			<div class="col-md-9">
				<input id="job" type="text" class="form-control" name="job" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="timetowork" class="col-md-3 control-label">参加工作时间</label>
			<div class="col-md-9">
				<input id="timetowork" type="text" class="form-control" name="timetowork" maxlength="20">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="mobilephone" type="text" class="form-control" name="mobilephone" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="telephone" class="col-md-3 control-label">固定号码</label>
			<div class="col-md-9">
				<input id="telephone" type="text" class="form-control" name="telephone" maxlength="20">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="archiveplace" type="text" class="form-control" name="archiveplace" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="technicaltitle" class="col-md-3 control-label">技术职称</label>
			<div class="col-md-9">
				<input id="technicaltitle" type="text" class="form-control" name="technicaltitle" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="sociallevel" class="col-md-3 control-label">社会阶层类型</label>
			<div class="col-md-9">
				<input id="sociallevel" type="text" class="form-control" name="sociallevel" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="situation" class="col-md-3 control-label">一线情况</label>
			<div class="col-md-9">
				<input id="situation" type="text" class="form-control" name="situation" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label for="training" class="col-md-3 control-label">培训情况</label>
			<div class="col-md-9">
				<input id="training" type="text" class="form-control" name="training" maxlength="20">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="offdate" type="text" class="form-control" name="offdate" maxlength="20">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input id="floatdirection" type="text" class="form-control" name="floatdirection" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-9 ">
				...
				<input id="infoprecent" type="hidden" class="form-control" name="infoprecent" maxlength="20">
			</div>
		</div>
